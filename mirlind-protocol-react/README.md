...
- 🗓️ **9-Month Roadmap** (day-by-day schedule)
- 💪 **Baki Body Program** (gym, nutrition, progression)
- 🧠 **Fang Yuan Mindset** (daily principles, discipline)
- 🇩🇪 **German Protocol** (A1→B1, visa/citizenship)
- 💻 **Job-First Coding Path** (6-9 months to employment)
- 💰 **Financial Reality** (survive until job)
- 📱 **App Features** (what to build for yourself)
- 📊 **Weekly Scorecards** (track everything)
...
This app tracks your entire transformation:
...
| **💰 Capital** | Expenses, budget, savings progress (€5,233 goal) |
