    ...
    <div className="max-w-4xl mx-auto pb-8 space-y-6">
      ...
      {isLoading ? (
        ...
        >
          ...
          <div>
            <label className="block text-sm font-medium text-secondary mb-2">Goal target date</label>
            <input
              type="date"
...
function LabeledNumberInput({
  ...
  return (
    <div>
      <label className="block text-sm font-medium text-secondary mb-2 capitalize">{label}</label>
      <input
        type="number"
        step="0.01"
        value={value}
