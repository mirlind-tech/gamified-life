...
import { EMOJIS, getSkillEmoji } from "@/lib/emojis";
          ...
          <div className="mt-6">
            <div className="progress-bar h-3">
              <motion.div
                ...
                className="progress-fill h-3 bg-gradient-to-r from-purple-500 via-cyan-500 to-purple-500"
              />
            </div>
      ...
      >
        ...
        <div className="mt-4">
          ...
          <div className="progress-bar h-2">
            <div
              className="progress-fill h-2 bg-gradient-to-r from-purple-500 to-cyan-500"
