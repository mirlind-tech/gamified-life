            ...
            >
              ...
              <div className="progress-bar mb-4">
                <motion.div
                  ...
                  className="progress-fill bg-linear-to-r from-cyan to-purple"
                />
              </div>
                  ...
                  <div key={skill.key} className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="progress-bar h-1.5">
                        <div
                          className={`progress-fill h-1.5 bg-linear-to-r from-purple-500 to-cyan-500 w-[${skill.progress}%]`}
                        />
                      </div>
                    </div>
                  </div>
              ...
              {inProgressSkills.length > 0 ? (
                <div className="space-y-3">
                  {inProgressSkills.slice(0, 2).map((skill) => (
                    <div
                      key={skill.key}
                      className="flex items-center gap-4 p-4 rounded-xl bg-linear-to-r from-purple/10 to-cyan/10 border border-purple/20"
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="progress-bar mt-2">
                          <div
                            className={`progress-fill bg-linear-to-r from-purple-500 to-cyan-500 w-[${skill.progress}%]`}
                          />
                        </div>
                      </div>
                      <Link
