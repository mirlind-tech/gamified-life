        ...
        <div className="flex-1 overflow-y-auto space-y-4 pr-2">
                ...
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center text-lg shrink-0 ${
                    message.role === "user"
                      ...
                      : "bg-linear-to-br from-cyan-500 to-green-500"
                  }`}
                >
                  {message.role === "user" ? "👤" : "🤖"}
                </div>
          ...
          {isLoading && streamingContent && (
            <motion.div
              ...
              className="flex gap-3"
            >
              <div className="w-10 h-10 rounded-full bg-linear-to-br from-cyan-500 to-green-500 flex items-center justify-center text-lg">
                🤖
              </div>
      ...
      >
        <div className="flex gap-3">
          ...
          <button
            ...
            className="px-6 py-3 rounded-xl bg-linear-to-r from-purple-500 to-cyan-500 text-white font-medium disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-lg hover:shadow-purple-500/25 transition-all"
          >
            {isLoading ? "..." : "Send"}
          </button>
        </div>
