          ...
          >
            ...
            >
              ...
              <form onSubmit={handleWorkoutSubmit} className="space-y-4">
                <div>
                  <label htmlFor="workout-type" className="block text-sm text-secondary mb-1">Workout Type</label>
                  <select
                    id="workout-type"
                ...
                <div>
                  <label htmlFor="workout-duration" className="block text-sm text-secondary mb-1">Duration (minutes)</label>
                  <input
                    id="workout-duration"
                    type="number"
                    min="5"
                    ...
                    return (
                      ...
                      >
                        <motion.div
                          ...
                          className="w-full bg-linear-to-t from-cyan/50 to-cyan rounded-t"
                        />
    ...
    <div className="space-y-2">
      ...
      <div className="progress-bar">
        <motion.div
          ...
          className={`progress-fill ${isComplete ? "bg-green" : "bg-linear-to-r from-purple-500 to-cyan-500"}`}
        />
      </div>
    </div>
  );
